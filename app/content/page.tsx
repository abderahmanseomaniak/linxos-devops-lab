...
import { ContentCard } from "@/components/screens/content/ContentCard"
import { ContentDetailsModal } from "@/components/screens/content/ContentDetailsModal"
  ...
  return (
    <div className="h-full flex flex-col gap-6 p-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        <TabsList className="h-10 w-fit gap-1 bg-transparent border-b rounded-none px-0">
          <TabsTrigger
            value="all"
            className="h-9 px-4 rounded-md data-[state=active]:bg-muted"
          >
            All ({events.length})
          </TabsTrigger>
          <TabsTrigger
