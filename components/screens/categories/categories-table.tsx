...
import { TableCategoriesToolbar } from "./parts/table-categories-toolbar"
...
export function CategoriesTable({
  ...
  const [showDelete, setShowDelete] = useState<ProductCategory | null>(null)
  ...
  const columns: ColumnDef<ProductCategory>[] = [
    ...
    },
    {
      ...
      header: "Produits",
      size: 100,
      cell: ({ row }) => <span className="text-sm">{row.original.products?.length ?? 0}</span>,
    },
    {
      id: "actions",
      size: 80,
