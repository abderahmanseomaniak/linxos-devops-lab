...
import { IconAdjustments, IconCircleX, IconColumns3, IconFilter, IconRefresh } from "@tabler/icons-react"
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="outline" className="h-8 text-xs" onClick={fetch}>
