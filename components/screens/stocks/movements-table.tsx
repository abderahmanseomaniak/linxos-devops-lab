...
import {
  IconAdjustments, IconCircleX, IconColumns3, IconDotsVertical, IconFilter, IconRefresh,
...
export function MovementsTable({ data, loading, onRefresh, onViewDetails }: MovementsTableProps) {
