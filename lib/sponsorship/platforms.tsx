...
const icons: Record<Platform, ReactNode> = {
  ...
  tiktok: (
    <svg className="size-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12.53 2h3.05c.26 1.79 1.27 3.33 2.74 4.26a6.94 6.94 0 0 0 3.68 1.06v3.1a10 10 0 0 1-5.42-1.63v7.28a6.43 6.43 0 1 1-6.43-6.43c.36 0 .71.03 1.05.09v3.18a3.34 3.34 0 1 0 2.33 3.18V2Z" />
    </svg>
  ),
  facebook: (
    <svg className="size-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
